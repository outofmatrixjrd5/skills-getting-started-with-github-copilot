document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear loading message and reset the selector to avoid duplicates on refresh
              ...
              .map(
                (email) => `
                  <div class="participant-item" data-activity="${name}" data-email="${email}">
                    ...
                    <button type="button" class="delete-participant" aria-label="Remove ${email}" title="Remove ${email}">
